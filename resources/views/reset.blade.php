            ...
            <form action="{{ route('reset-password.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" placeholder="Enter your new password..." name="password"
                        value="{{ old('password') }}" class="Rounded-Rectangle-2 form-control fs14 h40">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" placeholder="Enter your new password again..." name="password_confirmation"
                        value="{{ old('password_confirmation') }}" class="Rounded-Rectangle-2 form-control fs14 h40">
