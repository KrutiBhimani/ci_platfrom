        ...
        <div class="tab-pane show active" id="userc">
            <div class="table-responsive">
                    ...
                    @foreach ($skills as $skill)
                        <tr>
                            ...
                            <td class="p-3 pe-0 p-0 fs20">
                                <a href="/admin/skill/{{ $skill->skill_id }}/edit"><i class="fa fa-pencil-square-o co fs20" aria-hidden="true"></i></a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content p-2">
                                            ...
                                            <div class="modal-footer mt-3 justify-content-center border-top-0">
                                                <form action="{{route('skill.destroy',$skill->skill_id)}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#popup{{ $skill->skill_id }}"><i class="fa fa-trash-o text-dark fs20" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <ul class="pagination pager justify-content-end">
                    ...
                    @else
                    <li class='page-item'><a class='page-link peginate' href='/admin/skill?page=1'><img src='/storage/images/previous.png' alt=''></a></li>
                    <li class='page-item'><a class='page-link peginate' href='/admin/skill?page={{$previous}}'><img src='/storage/images/left.png' alt=''></a></li>
                    @endif
                    @for ($i = 1; $i <= $cnt; $i++) 
                    @if ($i == $page)
                    <li class='page-item'><a class='page-link active text-center peginate p-0 pt-1' href='/admin/skill?page={{$i}}'><b>{{$i}}</b></a></li>
                    @else
                    <li class='page-item'><a class='page-link text-center text-dark peginate p-0 pt-1' href='/admin/skill?page={{$i}}'>{{$i}}</a></li>
                    @endif
                    @endfor
                    @if ($page == $cnt) 
                    ...
                    @else 
                    <li class='page-item'><a class='page-link peginate' href='/admin/skill?page={{$next}}'><img src='/storage/images/arrow.png' alt=''></a></li>
                    <li class='page-item'><a class='page-link peginate' href='/admin/skill?page={{$cnt}}'><img src='/storage/images/next.png' alt=''></a></li>
                    @endif
                </ul>
            </nav>
            @endif
