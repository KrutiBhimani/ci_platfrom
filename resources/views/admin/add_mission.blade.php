        ...
        $('#selecttype').change(function() {
            ...
            if (selectedOptions.length > 0) {
                ...
                selectedOptions.each(function() {
                    var val = $(this).val();
                    if (val == "TIME")
                        resultString += "<p class='mb-1 mt-4 fs14'>Total Seats</p><input type='number' class='popup' name='total_seat'><p class='mb-1 mt-4 fs14'>Registration Deadline</p><input type='datetime-local' step='1' class='popup' name='deadline'>";
                    else
