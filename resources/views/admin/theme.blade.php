...
<div class="p-3">
    ...
    <div class="d-flex justify-content-between mt-4 mb-4">
        ...
        <a class="col-example1" href="add_theme" style="font-size:calc(12px + 0.15vw); padding-top: 7px;">
            ...
            <div class="table-responsive">
                <table class="table" style="border: 1px solid #dee2e6;">
                    ...
                    @foreach ($themes as $theme)
                        <tr>
                            <td class="p-3 pe-0" style="font-size:13px;">{{ $theme->title }}</td>
                            <td class="p-3 pe-0" style="font-size:13px;color: #7ed470;">{{ $theme->status=='1' ? 'Active' : 'Inactive' }}</td>
                            <td class="p-3 pe-0 p-0" style="font-size:20px;">
                                <a href="edit_theme"><i class="fa fa-pencil-square-o" style="color: #f88634;" aria-hidden="true"></i></a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content p-2">
                                            ...
                                            <div class="modal-footer mt-3 justify-content-center" style="border-top:0 ;">
                                                ...
                                                <a href="theme?source=delete_theme&amp;delete=MVNFQ1JFVF9TVFVGRg==" class="col-example7">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
