...
@section('content')
    ...
    <div class="m-3">
        ...
        <div class="d-flex align-content-end justify-content-end">
            <a href="/admin/approve_story/{{ $story->story_id }}" class="col-example mt-4 mb-4 me-3"><i
                    class="fa fa-check-circle-o mt-1 mb-1 me-2"></i>Approve</a>
            <a href="/admin/decline_story/{{ $story->story_id }}" class="col-example mt-4 mb-4 me-3"><i
                    class="fa fa-times-circle-o mt-1 mb-1 me-2"></i>Decline</a>
            <a href="#" class="col-example mt-4 mb-4" data-bs-toggle="modal"
                data-bs-target="#popup{{ $story->story_id }}"><i class="fa fa-trash-o mt-1 mb-1 me-2"
