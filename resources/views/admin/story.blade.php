                            ...
                            @foreach ($stories as $story)
                                <tr>
                                    ...
                                    <td class="p-3 pe-0 p-0 fs20">
                                        ...
                                        <a href="/admin/approve_story/{{ $story->story_id }}"><i
                                                class="fa fa-check-circle-o pe-2 gc fs20" aria-hidden="true"></i></a>
                                        <a href="/admin/decline_story/{{ $story->story_id }}"><i
                                                class="fa fa-times-circle-o text-danger pe-2 fs20"
                                                aria-hidden="true"></i></a>
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#popup{{ $story->story_id }}"><i
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content p-2">
                                                    ...
                                                    <div class="modal-footer mt-3 justify-content-center border-top-0">
                                                        <form action="{{ route('story.destroy', $story->story_id) }}"
                    ...
                    @if (request()->input('search') == '')
                        <nav aria-label="Page navigation example">
                            <ul class="pagination pager justify-content-end">
                                ...
                                @else
                                    <li class='page-item'><a class='page-link peginate'
                                            href='/admin/story?page={{ $next }}'><img
                                                src='/storage/images/arrow.png' alt=''></a></li>
                                    <li class='page-item'><a class='page-link peginate'
                                            href='/admin/story?page={{ $cnt }}'><img
                                                src='/storage/images/next.png' alt=''></a></li>
                                @endif
                            </ul>
                        </nav>
