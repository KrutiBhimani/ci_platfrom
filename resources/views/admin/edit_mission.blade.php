                ...
                <tr>
                    <td class="p-3 fs-6">
                        ...
                        <input type="text" class="popup" name="organization_detail"
                            value="{{ $mission->organization_detail }}">
                        ...
                        <div id='divresult1'>
                            @if ($mission->mission_type == 'TIME')
                                ...
                                <input type="datetime-local" step="1" class='popup' name='deadline'
                                    value="{{ $time->deadline }}">
                            @else
                                <p class='mb-1 mt-4 fs14'>Goal</p>
                                <input type='text' class='popup' name='goal_objective_text'
                                    value="{{ $goal->goal_objective_text }}">
                                <p class='mb-1 mt-4 fs14'>Goal Value</p>
                                <input type="number" step="1" class='popup' name='goal_value'
                        ...
                        <select class="popup pt-0 pb-0" name="availability">
                            ...
                            <option value="monthly" {{ $mission->availability == 'monthly' ? 'selected' : '' }}>Monthly
                            </option>
                        </select>
                    </td>
                </tr>
            ...
            $('#selecttype').change(function() {
                ...
                if (selectedOptions.length > 0) {
                    ...
                    selectedOptions.each(function() {
                        ...
                        if (val == "TIME") {
                            resultString +=
                                "<p class='mb-1 mt-4 fs14'>Total Seats</p><input type='number' class='popup' name='total_seat'><p class='mb-1 mt-4 fs14'>Registration Deadline</p><input type='date' class='popup' name='deadline'>";
