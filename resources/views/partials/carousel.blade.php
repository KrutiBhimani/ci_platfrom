...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-indicators" style='bottom:2%;'>
        ...
        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="{{$slide}}" class="active border-top-0 border-bottom-0" aria-current="true" aria-label="Slide {{$banner->sort_order}}" style="border-radius:15px;width:8px;height: 8px;"></button>
        @else
        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="{{$slide}}" aria-label="Slide {{$banner->sort_order}}" class="border-top-0 border-bottom-0" style="border-radius:15px;width:8px;height: 8px;"></button>
        @endif
        @endforeach
    </div>
