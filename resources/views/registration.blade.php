...
@section('content')
    <div class="col-md-4 col-sm-12 d-md-flex align-items-center position-relative">
            ...
            <form action="{{ route('registration.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" placeholder="Enter your first name..." name="first_name"
                        value="{{ old('first_name') }}" class="Rounded-Rectangle-2 form-control fs14 h37">
                </div>
                <div class="form-group mb-3">
                    <span class="Email">Lastname</span>
                    <input type="text" placeholder="Enter your last name..." name="last_name"
                        value="{{ old('last_name') }}" class="Rounded-Rectangle-2 form-control fs14 h37">
                </div>
                <div class="form-group mb-3">
                    <span class="Email">Phone Number</span>
                    <input type="number" placeholder="Enter your phone number..." name="phone_number"
                        value="{{ old('phone_number') }}" class="Rounded-Rectangle-2 form-control fs14 h37">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" placeholder="Enter your email address..." name="email"
                        value="{{ old('email') }}" class="Rounded-Rectangle-2 form-control fs14 h37">
                    @if ($errors->has('email'))
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" placeholder="Enter your password..." name="password"
                        value="{{ old('password') }}" class="Rounded-Rectangle-2 form-control fs14 h37">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" placeholder="Enter your password again..." name="password_confirmation"
                        value="{{ old('password_confirmation') }}" class="Rounded-Rectangle-2 form-control fs14 h37">
        ...
        <a href="/policy"
            class="text-center position-absolute bottom-0 start-50 translate-middle p-0 m-0 mt-3 Privacy-Policy">Privacy
            Policy</a>
    </div>
@endsection
