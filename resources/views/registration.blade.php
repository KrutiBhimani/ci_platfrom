    ...
    <div class="Layer-52">
        ...
        <form action="{{ route('register.custom') }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" placeholder="Enter your password again..." name="password_confirmation" class="Rounded-Rectangle-2 form-control" style="font-size:14px; height:37px;">
