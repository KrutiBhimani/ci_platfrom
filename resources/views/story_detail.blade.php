    ...
    <div class="row">
                            ...
                            <div id="carousel-example" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner row w-100 mx-auto" role="listbox">
                                    ...
                                    <div class="carousel-item col-12 col-sm-6 col-md-4 col-lg-3 p-1 {{$key==0 ? 'active' : ''}}">
                                        @if($media->type == 'video')
                                        <iframe class="img-fluid mx-auto d-block w-100 ofit h100" src="{{$media->path}}"></iframe>
                                        @else
                                        <img src="{{$media->path}}" class="img-fluid mx-auto d-block w-100 ofit h100 pe-auto" alt="img1">
                                        @endif
                                    </div>
                                    @endforeach
                                </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-5 pt-5">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <img src="{{$story->avatar!=null ? '/storage/uplodes/'.$story->avatar : '/storage/images/user1.png'}}" class="rounded-circle" height="82px" width="78">
                    <p class="mb-0 fs13 text-center">{{$story->first_name.' '.$story->last_name}}</p>
                </div>
                <div class="d-flex align-items-end">
                    <div class="bdg2"><img src="/storage/images/eye.png" class="me-2">{{$story->view_count}} view</div>
                </div>
            </div>
            ...
            <div class="row mt-3 mb-3">
                <div class="col-lg-7 col-md-12 col-sm-12 col-12 mt-2">
                    <div class="col-example2 text-center fs132">
                        <a href="#" class="inh tinh" data-bs-toggle="modal" data-bs-target="#popup{{ $story->story_id }}">
                    ...
                    <div id="popup{{ $story->story_id }}" class="modal">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content p-2">
                                ...
                                <form action="{{ route('story_detail.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="text" name="story_id" value="{{ $story->story_id }}" hidden="">
    ...
    <div class="row mt-4">
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active1 gray ps-0" data-toggle="tab" href="#mission">{{$story->story_title}}</a>
                </li>
            </ul>
