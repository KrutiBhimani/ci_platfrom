    ...
    <div class="container-lg">
        ...
        <div class="row">
            <div class="col m-2 pb-5 " style="border: 1px solid #dee2e6; border-radius: 5px;">
                <div class="d-flex justify-content-between mb-4 mt-4">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#popup1" type="button"
                        class="col-example7 ps-2 pe-2 pt-1 pb-1" style="font-size:13px;">
                ...
                <div id="popupedit9" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                            ...
                            <div class="modal-body pb-0">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="popup" name="h" value="02"
                                            placeholder="Enter Spent Hours">
                                    </div>
                                    <div class="col">
                                        <p class="mb-1 mt-3">Minute</p>
                                        <input type="number" class="popup" name="m" value="45"
                ...
                <div id="popupdelete13" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Confirm Delete</p>
                ...
                <div id="popupedit13" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Please input below Volunteering Hours</p>
                            ...
                            <div class="modal-body pb-0">
                                ...
                                <select class="popup pt-0 pb-0" name="mission_id">
                                    ...
                                    <option value="94" selected="">CSR initiative stands for Coffee and Farmer
                                        Equity</option>
                                    <option value="97">Grow Trees – On the path to environment sustainability</option>
                                    <option value="98">Education Supplies for Every Pair of Shoes Sold</option>
                                    <option value="99">Nourish the Children in African country</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <p class="mb-1 mt-3">Minute</p>
                                        <input type="number" class="popup" name="m" value="01"
                                            placeholder="Enter Spent Minutes">
                                    </div>
                                </div>
                                <p class="mb-1 mt-3">Message</p>
                ...
                <div id="popupdelete14" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Confirm Delete</p>
                ...
                <div id="popupedit14" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Please input below Volunteering Hours</p>
                            ...
                            <div class="modal-body pb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <p class="mb-1 mt-3">Minute</p>
                                        <input type="number" class="popup" name="m" value="02"
                                            placeholder="Enter Spent Minutes">
                                    </div>
                                </div>
                                <p class="mb-1 mt-3">Message</p>
                ...
                <div id="popupdelete16" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Confirm Delete</p>
                ...
                <div id="popupedit16" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Please input below Volunteering Hours</p>
                ...
                <table class="w-100">
                    <thead>
                        <tr>
                            ...
                            <td class="pt-3 ps-3 pb-1" scope="col" style="font-size:13px; font-weight: bold;">Date
                            </td>
                            <td class="pt-3 ps-3 pb-1" scope="col" style="font-size:13px; font-weight: bold;">Hours
                            </td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit9"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete9"
                                    type="button" style="border:none;background-color:white;">
                        ...
                        <tr>
                            <td class="pt-3 ps-3" style="font-size:11px;">CSR initiative stands for Coffee and Farmer
                                Equity</td>
                            <td class="pt-3 ps-3" style="font-size:11px;">01/02/2023</td>
                            <td class="pt-3 ps-3" style="font-size:11px;">02h</td>
                            <td class="pt-3 ps-3" style="font-size:11px;">01min</td>
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit13"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete13"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-trash-o text-dark" style="font-size:15px" aria-hidden="true"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit14"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete14"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-trash-o text-dark" style="font-size:15px" aria-hidden="true"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit16"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete16"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-trash-o text-dark" style="font-size:15px" aria-hidden="true"></i>
                                </button>
                            </td>
            ...
            <div class="col m-2 pb-5" style="border: 1px solid #dee2e6; border-radius: 5px;">
                ...
                <div id="popupedit4" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                            ...
                            <div class="modal-body pb-0">
                                ...
                                <input type="text" class="popup" name="action" value="3"
                ...
                <div id="popupdelete6" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Confirm Delete</p>
                ...
                <div id="popupedit6" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Please input below Volunteering Goal</p>
                            ...
                            <div class="modal-body pb-0">
                                ...
                                <p class="mb-1 mt-3">Action</p>
                                <input type="text" class="popup" name="action" value="1"
                                    placeholder="Enter Action">
                                <p class="mb-1 mt-3">Message</p>
                ...
                <div id="popupdelete15" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Confirm Delete</p>
                ...
                <div id="popupedit15" class="modal" style="--bs-modal-width:900px;">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-2">
                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                <p class="mb-0" style="font-size:20px ;">Please input below Volunteering Goal</p>
                ...
                <table class="w-100">
                    <thead>
                        <tr>
                            ...
                            <td class="pt-3 ps-3 pb-1" scope="col" style="font-size:13px; font-weight: bold;">Action
                            </td>
                            <td class="pt-3 ps-3 pb-1 pe-3" scope="col" style="font-size:13px; font-weight: bold;">
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit4"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete4"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-trash-o text-dark" style="font-size:15px" aria-hidden="true"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit6"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete6"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-trash-o text-dark" style="font-size:15px" aria-hidden="true"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="pt-3 ps-3" style="font-size:11px;">
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupedit15"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-pencil-square-o" style="color: #f88634; font-size:15px"
                                        aria-hidden="true"></i>
                                </button>
                                <button class="p-0" data-bs-toggle="modal" data-bs-target="#popupdelete15"
                                    type="button" style="border:none;background-color:white;">
                                    <i class="fa fa-trash-o text-dark" style="font-size:15px" aria-hidden="true"></i>
                                </button>
                            </td>
