...
<div class="container-lg">
    <div class="row row-eq-height justify-content-center mt-5">
            ...
            <ul class="pagination pager justify-content-center">
                <li class="page-item"><a class="page-link" style="border-radius:5px; padding:9px; height:30px; width:30px; margin:4px;"><img src="/storage/images/previous.png" alt=""></a></li><li class="page-item"><a class="page-link" style="border-radius:5px; padding:9px; height:30px; width:30px; margin:4px;"><img src="/storage/images/left.png" alt=""></a></li><li class="page-item"><a class="page-link active text-center" href="stories?page=1" style="border-radius:5px; padding:5px; height:30px; width:30px; margin:4px; font-size:15px;"><b>1</b></a></li><li class="page-item"><a class="page-link" style="border-radius:5px; padding:9px; height:30px; width:30px; margin:4px;"><img src="/storage/images/arrow.png" alt=""></a></li><li class="page-item"><a class="page-link" style="border-radius:5px; padding:9px; height:30px; width:30px; margin:4px;"><img src="/storage/images/next.png" alt=""></a></li>            </ul>
        </nav>
    </div><br>
