        ...
        <div class="row">
                                        ...
                                        @foreach ($medias as $key => $media)
                                            <div
                                                ...
                                                <img src="{{ $media->media_path }}"
                                                    class="img-fluid mx-auto d-block w-100 ofit h100" alt="img1">
                                            </div>
                                        @endforeach
                                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-5 pt-4">
                    ...
                    <div class="bdg2">
                        @if ($mission->mission_type == 'TIME')
                            @if ($mission->start_date == null && $mission->end_date == null)
                                Ongoing Opportunity
                            @else
                                From {{ date('d-m-Y', strtotime($mission->start_date)) }} until
                ...
                <div class="row mt-3 mb-3">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt-2">
                        <div class="col-example2 text-center fs131">
                            ...
                            @endforeach
                            @if ($key == 1)
                                <a href="/unlike/{{ $mission->missionid }}" class="inh tinh"><i
                                        class="fa fa-heart text-danger me-2" aria-hidden="true"></i>Remove From
                                    Favourite</a>
                            @else
                                <a href="/like/{{ $mission->missionid }}" class="inh tinh"><i
                                        class="fa fa-heart-o text-dark me-2 text-white" aria-hidden="true"></i>Add to
                                    Favourite</a>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt-2">
                        <div class="col-example2 text-center fs131">
                            <a href="#" class="inh tinh" data-bs-toggle="modal"
                                data-bs-target="#popup{{ $mission->missionid }}">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content p-2">
                                    ...
                                    <form action="{{ route('home.store') }}" method="POST"
                                        ...
                                        @csrf
                                        <input type="text" name="mission_id" value="{{ $mission->missionid }}"
                                            hidden="">
                        ...
                        @if ($rateduser == 1 && $rate == 1)
                            @for ($x = 1; $x <= 5; $x++)
                                @if ($x < $rating->rating + 1)
                                    <a href='/edit_rating/{{ $x }}/{{ $mission->missionid }}'><img
                                            src='/storage/images/selected-star.png' class="pe-auto h20"></a>
                                @else
                                    <a href='/edit_rating/{{ $x }}/{{ $mission->missionid }}'><img
                                            src='/storage/images/star.png' class="pe-auto h22"></a>
                                @endif
                            @endfor
                        @elseif($rateduser == 0 && $rate == 1)
                            @for ($x = 1; $x <= 5; $x++)
                                <a href='/add_rating/{{ $x }}/{{ $mission->missionid }}'><img
                                        src='/storage/images/star.png' class="pe-auto h22"></a>
                            @endfor
                        @else
                            @for ($x = 0; $x < 5; $x++)
                ...
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    @if ($mission->mission_type == 'TIME')
                        @if (
                            ($mission->deadline != null && $current > $mission->deadline) ||
                                ($mission->end_date != null && $current > $mission->end_date))
                            @php
                                $key = 1;
                            @endphp
                        @endif
                    @endif
                    @if ($key == 0)
                        <a href="/home/{{ $mission->missionid }}/edit" class="inh">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                ...
                <div class="tab-content">
                                ...
                                @foreach ($documents as $document)
                                    <button class="col-example5 mt-2 fs131">
                                        ...
                                        <a href="{{ $document->document_path }}" target="_blank"
                                            class="inh">{{ $document->document_name }}</a>
                                    </button>
                                @endforeach
                            </div>
                        @endif
                    ...
                    <div class="tab-pane" id="comments">
                        <form action="{{ route('volunteering_mission.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                                ...
                                @foreach ($comments as $comment)
                                    <div class="row mt-2 mb-2 p-3 ms-0 me-0 bgw">
                                        <div class="col-lg-1 col-md-2 col-sm-2 col-12 p-0">
                                            <img src="{{ $comment->avatar != null ? '/storage/uplodes/' . $comment->avatar : '/storage/images/user1.png' }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            @for ($x = 0; $x < 5; $x++)
                                                ...
                                                @endif
                                            @endfor
                                            <span class="gray2">(by {{ $rate_count > 0 ? $rate_count : '0' }}
                                                volunteers)</span>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <div class="row">
                                ...
                                @foreach ($vols as $vol)
                                    <div class="col-4 text-center p-0">
                                        <img src="{{ $vol->avatar != null ? '/storage/uplodes/' . $vol->avatar : '/storage/images/user1.png' }}"
                                            class="rounded-circle h60">
                    ...
                    <table class="table table-bordered m-0 text-center">
                        <tbody>
                            <tr class="border-bottom-0 border-start-0">
                                ...
                                @endphp
                                @if ($page == 1)
                                    <td class="border-bottom-0 border-start-0"><img src="/storage/images/left.png"
                                            class="h12"></td>
                                @else
                                    <td class="border-bottom-0 border-start-0"><a
                                            href='/volunteering_mission/{{ $mission->missionid }}?page={{ $previous }}'><img
                                                src="/storage/images/left.png" class="h12"></a></td>
                                @endif
                                <td class="border-bottom-0 border-start-0">{{ $postno + 1 }}-{{ $postno + $count }} of
                                    {{ $cnts }} Recent Volunteers</td>
                                @if ($page == $cnt)
                                    <td class="border-bottom-0 border-end-0"><img src="/storage/images/right-arrow1.png"
                                            class="h12"></td>
                                @else
                                    <td class="border-bottom-0 border-end-0"><a
                                            href='/volunteering_mission/{{ $mission->missionid }}?page={{ $next }}'><img
                                                src="/storage/images/right-arrow1.png" class="h12"></a></td>
                                @endif
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-5 d-flex align-items-stretch">
                        <div class="card box border-0">
                            <div class="gfg">
                                ...
                                <div class="d-flex align-items-center first-txt"><img src="/storage/images/pin.png"
                                        alt="" class="img-fluid pe-1 h12">
                                    {{ $mission->name }}
                                </div>
                                @php
                                    $a = 0;
                                ...
                                <div class="d-flex align-items-center second-txt2 p-2">
                                    ...
                                    @endforeach
                                    @if ($key == 1)
                                        <a href="/unlike/{{ $mission->missionid }}"><i class="fa fa-heart text-danger"
                                                aria-hidden="true"></i></a>
                                    @else
                                        <a href="/like/{{ $mission->missionid }}"><i class="fa fa-heart-o text-white"
                                                aria-hidden="true"></i></a>
                                    @endif
                                </div>
                                <div class="d-flex align-items-center third-txt p-2"><a href="" class="text-dark"
                                        data-bs-toggle="modal" data-bs-target="#popup{{ $mission->missionid }}"><img
                                            src="/storage/images/user.png" alt="" class="img-fluid h17"></a>
                                </div>
                                <div id="popup{{ $mission->missionid }}" class="modal">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content p-2">
                                    ...
                                    <div class="card-body pb-3 remove">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="icon">
                                                @for ($x = 0; $x < 5; $x++)
                                                    @if ($x < $mission->rating)
                                                        <img src="/storage/images/selected-star.png" alt=""
                                                            class="star">
                                                    @else
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-9">
                                                                @foreach ($applications as $application)
                                                                    @if ($application->missionid == $mission->missionid)
                                                                        {{ $mission->total_seat - $application->count }}
                                                                        <h6 class="mb-2 text-secondary fs12">Seats Left
                                                                        </h6>
                                                                    @endif
                                                                @endforeach
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-9">
                                                                @foreach ($applications as $application)
                                                                    @if ($application->missionid == $mission->missionid)
                                                                        {{ $application->count }}
                                                                        <h6 class="mb-2 text-secondary fs12">Already
                                                                            volunteered</h6>
                                                                    @endif
                                                                @endforeach
                                                            </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-6" class="text-dark">
                                                    <div class="row">
                                                        <div class="col-lg-1 col-md-1 col-sm-1 col-1 m-1 mt-0 mb-0"><img
                                                                src="/storage/images/achieved.png" alt=""
                                                                class="h22"></div>
                                                        @php
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-9">
                                                            ...
                                                            <h6 class="mb-2 text-secondary fs12">{{ $goal_achieved }}
                                                                achieved</h6>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                @else
                                    <a href="/volunteering_mission/{{ $mission->missionid }}" class="inh"><button
                                            class=" col-example mt-3 fs131">View Detail<i
                                                class="fa fa-arrow-right ps-2"></i></button></a>
                                @endif
                            </div>
                        </div>
